...
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype, shortcut, width, height, scrollbar)
values ('01030102', '调色板', '010301', 'theme2Icon', '0', 'resource.do?reqCode=colorPaletteInit', '1', 2, null, 'theme2.png', '0', 'paint.png', null, null, '0');
insert into EAMENU (menuid, menuname, parentid, iconcls, expanded, request, leaf, sortno, remark, icon, menutype, shortcut, width, height, scrollbar)
...
insert into EAPARAM (paramid, paramkey, paramvalue, remark)
values ('10000017', 'SYS_TITLE', 'G4Studio：JavaEE行业应用二次快速开发平台V5.0', '系统标题');
insert into EAPARAM (paramid, paramkey, paramvalue, remark)
values ('10000018', 'LOGIN_WINDOW_TITLE', 'G4Studio - JavaEE行业应用二次快速开发平台V5.0', '登录窗口标题');
insert into EAPARAM (paramid, paramkey, paramvalue, remark)
...
insert into EAPARAM (paramid, paramkey, paramvalue, remark)
values ('10000030', 'EXCEPTION_CLIENT_MSG', '异常信息。', '客户端异常响应概要信息');
insert into EAPARAM (paramid, paramkey, paramvalue, remark)
...
values ('10000000', '超级用户', 'super', 'RaFutWeh0ww=', '1', '001', '0', '超级用户,享有系统最高管理权限', '3', '1');
insert into EAUSER (userid, username, account, password, sex, deptid, locked, remark, usertype, enabled)
values ('10000001', '开发人员', 'developer', 'RaFutWeh0ww=', '0', '001', '0', '1', '3', '1');
insert into EAUSER (userid, username, account, password, sex, deptid, locked, remark, usertype, enabled)
values ('10004885', '熊春_a_1', 'xiongchun_a_1', 'RaFutWeh0ww=', '0', '001002001006001', '0', '昆明市社保局管理员', '2', '1');
insert into EAUSER (userid, username, account, password, sex, deptid, locked, remark, usertype, enabled)
values ('10004886', '熊春_b_1', 'xiongchun_b_1', 'RaFutWeh0ww=', '0', '001002001006001', '0', null, '1', '1');
insert into EAUSER (userid, username, account, password, sex, deptid, locked, remark, usertype, enabled)
values ('10004887', '熊春_a_2', 'xiongchun_a_2', 'RaFutWeh0ww=', '0', '001002001006001001', '0', '五华区社保局管理员', '2', '1');
insert into EAUSER (userid, username, account, password, sex, deptid, locked, remark, usertype, enabled)
values ('10004888', '熊春_b_2', 'xiongchun_b_2', 'RaFutWeh0ww=', '0', '001002001006001001', '0', '五华区社保局业务经办员', '1', '1');
insert into EAUSER (userid, username, account, password, sex, deptid, locked, remark, usertype, enabled)
values ('10004889', '熊春_a_3', 'xiongchun_a_3', 'RaFutWeh0ww=', '0', '001002001006001002', '0', '盘龙区社保局管理员', '2', '1');
insert into EAUSER (userid, username, account, password, sex, deptid, locked, remark, usertype, enabled)
values ('10004890', '熊春_b_3', 'xiongchun_b_3', 'RaFutWeh0ww=', '0', '001002001006001002', '0', '盘龙区社保局业务经办员', '1', '1');
commit;
